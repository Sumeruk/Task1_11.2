...
//    if (alphabet.indexOf((char)mapA.get(i)) != -1 && znak.indexOf((char)mapA.get(i+1)) == 3
//                    && (alphabet.indexOf((char)mapA.get(i+2)) != -1) && mapA.get(i)==mapA.get(i+2)){
//                otv = otv x * x;
//            } else {
//                if (alphabet.indexOf((char)mapA.get(i)) != -1 && znak.indexOf((char)mapA.get(i+1)) == 3
//                        && (alphabet.indexOf((char)mapA.get(i+2)) != -1) && mapA.get(i)!=mapA.get(i+2)){
//                    otv = x * y;
//                } else {
//                    if (alphabet.indexOf((char)mapA.get(i)) != -1 && znak.indexOf((char)mapA.get(i+1)) == 0
//                            && (alphabet.indexOf((char)mapA.get(i+2)) != -1) && mapA.get(i)!=mapA.get(i+2)){
//                        otv
//                    }
//                }
...
//        if (alphabet.indexOf(formula.charAt(i)) != -1){
//            mapA.put("perem"+i,formula.charAt(i));
//        } else {
//            if (znak.indexOf(formula.charAt(i)) != -1){
//                mapA.put("znak"+i,formula.charAt(i));
//            }
//        }
//    }
...
//            if ((char) mapA.get(first.get(i)) == znak.charAt(3)) {
//                mapA.remove(first.get(i));
//                if (mapA.get(first.get(i) - 1) == mapA.get(first.get(i) + 1)) {
//                    mapA.put(first.get(i), x + x);
//                } else {
//                    if (mapA.get(first.get(i) - 1) != mapA.get(first.get(i) + 1)) {
//                        mapA.put(first.get(i), x * y);
//                    }
//                }
//            } else {
//                if ((char) mapA.get(first.get(i)) == znak.charAt(2)) {
//                    mapA.remove(first.get(i));
//                    if (mapA.get(first.get(i) - 1) == mapA.get(first.get(i) + 1)) {
//                        mapA.put(first.get(i), 1);
//                    } else {
//                        if (mapA.get(first.get(i) - 1) != mapA.get(first.get(i) + 1)) {
//                            mapA.put(first.get(i), x / y);
//                        }
...
//            if ((char) mapA.get(second.get(i)) == znak.charAt(0)) {
//                mapA.remove(second.get(i));
//                if (mapA.get(second.get(i) - 1) == mapA.get(second.get(i) + 1)) {
//                    mapA.put(second.get(i), x + x);
//                } else {
//                    if (mapA.get(second.get(i) - 1) != mapA.get(second.get(i) + 1)) {
//                        mapA.put(second.get(i), x + y);
//                    }
//                }
//            } else {
//                if ((char) mapA.get(second.get(i)) == znak.charAt(2)) {
//                    mapA.remove(second.get(i));
//                    if ( !second.contains((int)mapA.get(second.get(i-2))) )
//                        if (mapA.get(second.get(i) - 1) == mapA.get(second.get(i) + 1)) {
//                            mapA.put(second.get(i), 0);
//                        } else {
//                            if (mapA.get(second.get(i) - 1) != mapA.get(second.get(i) + 1)) {
//                                mapA.put(second.get(i), x - y);
//                            }
